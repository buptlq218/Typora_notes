...
from transformers import AutoTokenizer, Qwen2_5_VLForConditionalGeneration, CLIPImageProcessor
from transformers import BitsAndBytesConfig
from transformers import Trainer, AutoProcessor, DataCollatorForSeq2Seq
...
# inside main or appropriate scope
from accelerate import Accelerator


#accelerator = Accelerator()
#os.environ["PT_DISTRIBUTED_ENABLE_DTENSOR"] = "0"
...
swanlab_callback = SwanLabCallback(
    ...
    experiment_name="qwen2.5-vl-multilayer",
    config={
...
tokenizer = AutoTokenizer.from_pretrained("/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen7/Qwen/Qwen2___5-VL-7B-Instruct/", use_fast=False, trust_remote_code=True)
processor = AutoProcessor.from_pretrained("/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen7/Qwen/Qwen2___5-VL-7B-Instruct/")
...
model = Qwen2_5_VLForConditionalGeneration.from_pretrained(
    "/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen7/Qwen/Qwen2___5-VL-7B-Instruct/",
    device_map="auto",
...
#    if "lm_head" not in name:  # 或者你具体识别的分类/输出层
...
#解冻 Patch Embedding,其为图像输入最前层，控制模型对图像的“切块”方式，适配不同数据分布，提升低层特征对齐
#for name, param in model.named_parameters():
#    if "visual.patch_embed" in name:
#        param.requires_grad = True

#适度解冻语言主干中图文信息交互较频繁层（22~27），图文融合后的 token 会逐步传播进语言模型，这些中间层负责融合后的语义建模
...
#解冻 Vision → Text 投影层
for name, param in model.named_parameters():
    if "proj" in name and "visual" in name:
        param.requires_grad = True
...
training_args = TrainingArguments(
    output_dir="/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen7/Qwen/output/",
    num_train_epochs=8,
    per_device_train_batch_size=1,  # 根据显存调整
    per_device_eval_batch_size=1,
    gradient_accumulation_steps=8,  # 等效于更大的 batch_size
    learning_rate=2e-5,
    weight_decay=0.01,
    logging_steps=50,
    save_steps=100,
