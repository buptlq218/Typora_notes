...
tokenizer = AutoTokenizer.from_pretrained("/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen/Qwen2-VL-2B-Instruct/", use_fast=False, trust_remote_code=True)
processor = AutoProcessor.from_pretrained("/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen/Qwen2-VL-2B-Instruct/")

model = Qwen2VLForConditionalGeneration.from_pretrained("/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen/Qwen2-VL-2B-Instruct/", device_map="auto",
                                                        torch_dtype=torch.bfloat16, trust_remote_code=True, )
model.enable_input_require_grads()  # 开启梯度检查点时，要执行该方法

# 处理数据集：读取json文件
# 拆分成训练集和测试集，保存为data_vl_train.json和data_vl_test.json
# train_json_path = "/home/wjx/PythonWorkSpace/Code/ModelChange/train/DatasetResult_BPSK_300.json"
...
# 获取测试模型
val_peft_model = PeftModel.from_pretrained(model, model_id="/home/wjx/PythonWorkSpace/Code/ModelChange/Qwen/Qwen2-VL-2B-Instruct-trained/*", config=val_config)
...
for item in test_dataset:
    ...
    origin_image_path = '/home/wjx/PythonWorkSpace/Code/' + item["image_path"].split('\\')[0] + '/' + item["image_path"].split('\\')[1] + '/' + item["image_path"].split('\\')[2]
    ...
    messages = [{
        ...
        "content": [
            ...
            {
                "type": "text",
                "text": "This is a time-frequency graph of a signal, please describe this signal for me."
            }
        ]}]
